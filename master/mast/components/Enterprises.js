Mast.registerTree('EnterprisesTable', {
    ...
    model: {
        ...
        Mast.Socket.request('/enterprises/listEnterprises/' + window.location.hash.split('/')['1'], null, function (res, err) {
            if (res) {
                var options = "";
...
// branch properties
    ...
    collection: {
        initialize: function (options) {
            ...
            this.url = '/enterprises/listEnterprises/' + Mast.Session.page;
        },
