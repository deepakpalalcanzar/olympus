...
/*					Directory.createWorkgroup({ name: 'Sample Workgroup' }, account.id, true
		...
		function (cb) {
			...
			// console.log("alskdjasldjasldasjkldasjskljadskalas");
			// console.log("alskdjasldjasldasjkldasjskljadskalas");
...
/*				console.log("BOOTSTRAPBOOTSTRAPBOOTSTRAPBOOTSTRAPBOOTSTRAPBOOTSTRAPBOOTSTRAPBOOTSTRAP");
...
*/
				...
				Developer.create({
					...
					/*console.log("DEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPER");
						console.log(developer.length);
					console.log('DEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPERDEVELOPER');
*/
