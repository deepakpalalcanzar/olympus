...
var ThemeController = {
    ...
    sendthemeResponse: function (res, dir, account_enter, trans) {
        ...
        var Rgb_header_background   = ""+ (dir.header_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.header_background).r)) +","+(dir.header_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.header_background).g))+","+(dir.header_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.header_background).b))+"";
        var Rgb_footer_background   = ""+ (dir.footer_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.footer_background).r)) +","+(dir.footer_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.footer_background).g))+","+(dir.footer_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.footer_background).b))+"";
        var Rgb_body_background     = ""+ (dir.body_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.body_background).r)) +","+(dir.body_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.body_background).g))+","+(dir.body_background === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.body_background).b))+"";
        var Rgb_navigation_color    = ""+ (dir.navigation_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.navigation_color).r)) +","+(dir.navigation_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.navigation_color).g))+","+(dir.navigation_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.navigation_color).b))+"";
        var Rgb_font_color          = ""+ (dir.font_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.font_color).r)) +","+(dir.font_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.font_color).g))+","+(dir.font_color === '#' || dir.header_background === 'undefined' ? null : (hexToRgb(dir.font_color).b))+"";                                
